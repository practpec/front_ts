...
import PerformanceMetrics from './components/PerformanceResults';
...
do {
  ...
  const [optimizedMetrics, setOptimizedMetrics] = useState<AnalysisWithMetrics | null>(null);
  const [unoptimizedMetrics, setUnoptimizedMetrics] = useState<AnalysisWithMetrics | null>(null);
  ...
  const handleAnalyzeOptimized = async () => {
    ...
    try {
      const result = await analyzeCodeOptimized(code);
      setOptimizedMetrics(result);
      ...
      console.error('Error al analizar código optimizado:', error);
    } finally {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <div className="container mx-auto py-8 px-4">
        ...
        {/* Métricas de comparación arriba */}
        {(optimizedMetrics || unoptimizedMetrics) && (
          <PerformanceMetrics 
            optimizedResult={optimizedMetrics}
            unoptimizedResult={unoptimizedMetrics}
          />
        )}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <CodeEditor 
              ...
              isLoadingOptimized={isLoadingOptimized}
